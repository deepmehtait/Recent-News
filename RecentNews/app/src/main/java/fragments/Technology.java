...
public class Technology extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view;
        view = inflater.inflate(R.layout.viewpager_technology, null);
        final ImageView imageView = (ImageView) view.findViewById(R.id.technologyImageView);
        final TextView textView = (TextView) view.findViewById(R.id.technologyTextView);
        final TextView topStoriesAgo = (TextView) view.findViewById(R.id.technologyAgo);
        ...
        if (AppStatus.getInstance(view.getContext()).isOnline()) {
            ...
            Snackbar.make(view.findViewById(R.id.technologyRR), "No Internet Connection", Snackbar.LENGTH_LONG)
                    .show();
        }
